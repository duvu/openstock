# Implementation roadmap (deprecated)
...
- GitHub Issues for priority, dependencies, scope, acceptance criteria and status;
- OpenSpec for requirements, design, tasks and validation evidence linked to an issue;
- stable documentation in this directory for architecture and product concepts.
