# chat-data-provisioning-contract Specification

## Purpose
Define the shared, bounded, fail-closed path that prepares current-symbol data
for CLI, TUI and assistant research while preserving typed diagnostics,
correlated audit evidence and the prohibition on assistant-owned unrestricted
fetching.
