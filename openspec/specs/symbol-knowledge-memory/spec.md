# symbol-knowledge-memory Specification

## Purpose
Define bounded, auditable and point-in-time-safe research memory for symbols and
supported market entities, including typed claims, lifecycle transitions,
selective projection, deterministic compaction and compatibility with existing
symbol workflows.
