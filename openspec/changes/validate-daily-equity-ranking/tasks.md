...
- [ ] 3.1 Implement next-session point-in-time walk-forward evaluation.
- [ ] 3.2 Add immutable market-friction, eligibility, and capacity assumptions.
- [ ] 3.3 Validate multiple periods, baselines, exclusions, and failure boundaries.

## 4. Full-universe product and evidence (#202-#205)

- [ ] 4.1 Deliver the daily full-universe shortlist through CLI/TUI/artifacts.
- [ ] 4.2 Add deterministic ranking validation and decision reports.
- [ ] 4.3 Persist immutable ranking batches and append-only later observations.
- [ ] 4.4 Evaluate one named-consumer FiinQuantX extension at a time.

## 5. Governance and epic closure (#206, #196)

- [ ] 5.1 Add immutable reviewed policy decisions and active-policy rollback.
- [ ] 5.2 Run clean-host full-universe E2E and all repository gates on the exact SHA.
- [ ] 5.3 Attach evidence, close #197-#206 in dependency order, then close #196.
