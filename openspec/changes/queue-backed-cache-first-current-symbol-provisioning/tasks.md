...
- [x] 4.3 Re-read and re-plan after claim. Evidence: `21c53513663a960d7334606bd035fcd4c4f9f016`, hardened by `079c32dfa3d59fd9bb345d5b730a0112035c2d45`; the current-symbol handler delegates to the existing verified current-symbol operation with the requested capability shape and the restart contract proves persisted effects are reused.
- [x] 4.4 Add bounded stage timeouts, lease extension and cooperative stop behavior. Evidence: `079c32dfa3d59fd9bb345d5b730a0112035c2d45`; the worker validates stage-timeout-plus-safety against the live lease, maintains the lease through each active stage, acknowledges cancellation at a safe boundary, and stops future claims on SIGINT/SIGTERM.
