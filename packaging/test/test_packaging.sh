...
# Usage:
#   test_packaging.sh [path/to/vnalpha.deb]
#   PACKAGING_TEST_GROUP=files|syntax|metadata|boundary|state test_packaging.sh
...
DEB_FILE="${1:-}"
GROUP="${PACKAGING_TEST_GROUP:-all}"
PASS=0
FAIL=0
